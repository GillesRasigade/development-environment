...
// Source: https://github.com/molnarg/node-http2/blob/master/example/server.js
...
var cachedFile = fs.readFileSync(path.join(__dirname, './index.js'));
...
} else if (process.env.HTTP2_PLAIN) {
